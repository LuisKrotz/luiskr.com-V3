  ...
  <div class="project">
    ...
    <div class="project-main">
      <video class="project-main-item" playsinline autoplay loop muted controls>
        <source :src="storage + 'aboutmarco/home/aboutmarco.com-2020-full-page-home-tour.mp4'" type="video/mp4">
      </video>
    </div>
