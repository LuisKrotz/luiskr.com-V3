        ...
        <div class="internal-extra-scroll">
            ...
            <div class="internal-extra-item">
                <Media
                  ...
                  :height="5017"
                  :canExpand="true"
                  label="MOR: store - category page screenshoot"/>
            </div>
            <div class="internal-extra-item">
                <Media
                  ...
                  :height="5112"
                  :canExpand="true"
                  label="MOR: store - product page screenshoot"/>
            </div>
        </div>
      </section>
        ...
        <div class="internal-extra-scroll">
            ...
            <div class="internal-extra-item">
                <Media
                  ...
                  :canExpand="true"
                  :isVideo="true"
                  label="MOR: where to find mobile tour"/>
            </div>
        </div>
      </section>
