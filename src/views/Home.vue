<template>
  <article :class="has_touch ? 'has_touch' : ''">
      <div id="portfolio" class="portfolio-title">
        <h2 class="hdn">{{ message }}:</h2>

        <div v-for="n in marquee" :key="n" class="portfolio-title-marquee" aria-hidden="true" data-no-snippet>
      ...
      portfoliolist:    [
        {
          ...
          height: ["750", "301"],
          label: 'Metcha',
          description: 'An oracle of leather, design and culture.<br>Developed at Transa, seeking to tell the most compelling stories within the worlds of design, art, fashion and lifestyle, shining a spotlight on the subjects and the individuals that make up the everyday lives of the people who shape the world.',
        },
        {
          link: 'melissa',
          image: 'melissa',
          ...
          height: ["799", "320"],
          label: 'Melissa',
          description: 'A Portal connecting all things related to the Melissa Brand.<br>It had many feeds connected with the brand social media and original content created at Transa.',
        },
        {
          link: 'minimelissa',
          ...
          height: ["799", "322"],
          label: 'Mini Melissa',
          description: 'A project developed at Transa for the Grendene Group as a channel for the Minimelissa brand.<br>The website consisted of a Content and a Social feed on the homepage with infinite scroll leading to many Minimelissa exclusive content and lasted from 2018 to 2020.',
        },
        {
          ...
          description: 'A project developed at Transa, through a partnership between CICB and Apex-Brasil.<br>The project is a portal of Leather from Brazil. Including websites like Brazilian Leather, CICB, CSCB and Leather Law.',
        },
        {
          link: 'mor',
          image: 'mor',
          ...
          height: ["798", "319"],
          label: 'Mor',
          description: 'A website developed at Transa with the goal create a fast and beautiful experience connecting MOR\'s channels and community in one place',
        },
        {
          link: 'coza',
          image: 'coza',
          ...
          height: ["794", "318"],
          label: 'Coza',
          description: 'A website developed at Transa from 2017 to 2019.<br>Coza\'s main page was a feed of content created for the brand, with articles, galleries, photos and links to the online store.',
        },
        {
          link: 'aboutmarco',
          image: 'aboutmarco',
          ...
          height: ["1014", "406"],
          label: 'Marco Almeida',
          description: 'Marco\'s Portfolio, developed as a Freelancing project in 2021.<br>The main goal to achieve was to create a pixel-perfect project, with smooth animations and a pixel perfect UI.',
        },
        {
        ...
        },
        {
          ...
          height: ["640", "256"],
          label: 'Cecerelê',
          description: 'An e-commerce that was developed as a freelancing project in 2021.<br>Cecerelê\'s is a store was designed by myself inside the Illuria e-commerce platform.',
        },
        {
          link: 'transa',
          image: 'transa',
          ...
          height: ["850", "369"],
          label: 'Transa',
          description: 'A website developed at and for Transa\'s company, consisting of an infinite scrolling feed, a custom  CMS, a join us and cases pages summarizing the projects developed during many years.',
        },
        {
          link: 'vibra',
          image: 'vibra',
          ...
          height: ["913", "340"],
          label: 'Vibra',
          description: 'A website developed at Transa in 2016 as a portal created for the Vibra Brand.',
        },
        {
          ...
          height: ["649", "369"],
          label: 'Sageweb',
          description: 'A project developed by Genesysinf, at the city of Santana do Livramento, in Brazil, and is a fiscal software.<br>The project consisted of porting the Sage for desktop software code to a new Web Version.',
        }],
